...
const AllCalculatorsPage = () => {
  const calculators = [
    ...
    },
    {
      ...
      description: "Advanced scientific calculator with trigonometric functions, logarithms, and more.",
    ...
    },
    {
      ...
      description: "Calculate your age in years, months, and days from your birth date.",
      path: "/calculator/age",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5 12 5.25l8.25 8.25M12 5.25v13.5" />
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      description: "Calculate sale prices and savings with discounts.",
    ...
    },
    {
      ...
      description: "Calculate fuel consumption and costs for trips.",
    ...
    {
      title: "Pregnancy Due Calculator",
      description: "Calculate your pregnancy due date and milestones.",
    ...
    },
    {
      ...
      description: "Calculate your daily calorie needs and macronutrients.",
    ...
    // New calculators
    {
      ...
      description: "Convert between different weight units like kilograms, pounds, ounces, and more.",
    ...
    },
    {
      ...
      description: "See how your savings will grow with compound interest over time.",
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore our comprehensive collection of calculators designed to help you with various calculations.
            </p>
          </div>
