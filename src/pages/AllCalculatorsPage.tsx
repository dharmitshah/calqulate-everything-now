  ...
  const calculators = {
    ...
    finance: [
      ...
      },
      {
        ...
        description: "Plan for your retirement and calculate savings goals.",
      ...
      },
      {
        ...
        description: "Calculate your home loan payments and amortization schedule.",
    ...
    health: [
      ...
      },
      {
        ...
        description: "Calculate daily caloric intake based on goals.",
      ...
      },
      {
        ...
        description: "Calculate your estimated due date based on conception or last period.",
    ...
    utility: [
      ...
      },
      {
        ...
        description: "Find the difference between two dates or add/subtract time.",
      ...
      },
      {
        ...
        description: "Generate random numbers with various parameters.",
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Browse our complete collection of calculators organized by category or use the search bar to find exactly what you need.
            </p>
          </div>
          ...
          {searchQuery ? (
            ...
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="finance" className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
                  {calculators.finance.map((calculator) => (
                    <CalculatorCard
                      key={calculator.title}
                      title={calculator.title}
                      description={calculator.description}
              ...
              <TabsContent value="utility" className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
                  {calculators.utility.map((calculator) => (
                    <CalculatorCard
                      key={calculator.title}
                      title={calculator.title}
                      description={calculator.description}
